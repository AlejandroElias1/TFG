...
class MainActivity8 : AppCompatActivity() {
    ...
    private fun sendMessage() {
        val sender = nombreUsuario // Utiliza el nombre de perfil del usuario actual
        ...
        if (messageText.isNotEmpty()) {
            ...
            val message = Message(messageId, sender, messageText, timestamp, sender) // Almacena el nombre de perfil en userProfileName
            messageId?.let {
